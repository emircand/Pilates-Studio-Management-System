package com.pilatesapp.app.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.pilatesapp.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.pilatesapp.app.security.DomainUserDetailsService", "createSpringSecurityUser");
